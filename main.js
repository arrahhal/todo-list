...
function createTask(
  ...
  let dueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(tDueDate) ? tDueDate : new Date();
  ...
  const updateTask = (
    ...
    const updatedDueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(newDueDate) ? newDueDate : dueDate;
...
const todoController = (() => {
  ...
  const setDefaultProjects = () => {
    projects.push(_projects__WEBPACK_IMPORTED_MODULE_0__.Inbox);
  };
  setDefaultProjects();

  // Add a new project with the given title
  const addProject = (title) => projects.push((0,_projects__WEBPACK_IMPORTED_MODULE_0__.createProject)(title));
  ...
  const loadDefaultInbox = () => {
    _projects__WEBPACK_IMPORTED_MODULE_0__.Inbox.addTask(
      (0,_tasks__WEBPACK_IMPORTED_MODULE_1__["default"])('task title', 'task desc', 'low', new Date(2023, 3, 6))
    );
    _projects__WEBPACK_IMPORTED_MODULE_0__.Inbox.addTask(
      (0,_tasks__WEBPACK_IMPORTED_MODULE_1__["default"])('task title', 'task desc', 'low', new Date(2023, 3, 6))
    );
  ...
  const getThisWeekTasks = () =>
    getAllTasks().filter((task) => (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(task.dueDate));
...
const uiController = (() => {
  ...
  const displayCurrentProject = (projectId) => {
    const projectTasks = _todo__WEBPACK_IMPORTED_MODULE_2__["default"].getProjectTasks(projectId)
  ...
  const displayTodayTasks = () => {
    const todayTasks = _todo__WEBPACK_IMPORTED_MODULE_2__["default"].getTodayTasks();
    appendTasksList(todayTasks);
  };
  today.addEventListener('click', displayTodayTasks);

  const displayWeekTasks = () => {
    const weekTasks = _todo__WEBPACK_IMPORTED_MODULE_2__["default"].getThisWeekTasks();
    appendTasksList(weekTasks);
  };
  week.addEventListener('click', displayWeekTasks);

  const displayCompletedTasks = () => {
    const completedTasks = _todo__WEBPACK_IMPORTED_MODULE_2__["default"].getCompletedTasks();
  ...
  const removeTask = (taskId) => {
    _todo__WEBPACK_IMPORTED_MODULE_2__["default"].removeTaskFromProject(taskId);
    appendTasksList(_todo__WEBPACK_IMPORTED_MODULE_2__["default"].getProjectTasks(currentProjectId));
  };
  ...
  const addUserProject = () => {
    _todo__WEBPACK_IMPORTED_MODULE_2__["default"].addProject(userProjectTitle.value);
  };
  ...
  const createProjectsList = () => {
    ...
    const userProjects = _todo__WEBPACK_IMPORTED_MODULE_2__["default"].getProjects()
  ...
  submitUserProject.addEventListener('click', (e) => {
    ...
    hideNewProjectForm();
    createProjectsList();
    console.log(_todo__WEBPACK_IMPORTED_MODULE_2__["default"].getProjects());
    e.preventDefault();
  });
  ...
  projectItemsList.addEventListener('click', (e) => {
    ...
    if (e.target.classList.contains('task-text'))
      _todo__WEBPACK_IMPORTED_MODULE_2__["default"].toggleTaskStatus(e.target.control.id);
...
const taskPanel = (() => {
  ...
  const addTaskToProject = () => {
    const task = (0,_tasks__WEBPACK_IMPORTED_MODULE_1__["default"])(
      taskTitle.value,
      taskDescription.value,
      taskPriority.value,
      taskDate.value
    );
    _todo__WEBPACK_IMPORTED_MODULE_2__["default"].addTaskToProject(task, taskProject.value);
    uiController.reloadCurrentProject();
  };
  const updateTask = (taskId) => {
    _todo__WEBPACK_IMPORTED_MODULE_2__["default"].updateTask(
      taskTitle.value,
      taskDescription.value,
      taskPriority.value,
      (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(taskDate.value),
      taskProject.value,
      taskId
    );
    uiController.reloadCurrentProject();
  ...
  const addProjectsOptions = () => {
    ...
    const projects = _todo__WEBPACK_IMPORTED_MODULE_2__["default"].getProjects();
  ...
  const displayUpdatePanel = (taskId) => {
    ...
    displayPanel();
    fillWithTaskInfo(_todo__WEBPACK_IMPORTED_MODULE_2__["default"].getTask(taskId));
  };
